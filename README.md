...
**上述编译命令**
```
xelatex --shell-escape 文件名#这里使用了Markdown,需要用到lua程序( Lua 解释器)，--shell-escape意思是加载外部程序
```
## 四、引用文献的说明
文献tex如下（使用第三章方案二）:
```
...
4. https://liam.page/2020/03/30/writing-manuscript-in-Markdown-and-typesetting-with-LaTeX/5. https://www.zhihu.com/question/358793900
